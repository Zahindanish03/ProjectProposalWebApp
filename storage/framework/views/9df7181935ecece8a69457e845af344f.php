                    ...
                    <div class="contact_wrap contact_style3 flex-fill">
                        ...
                        <div class="contact_text">
                            ...
                            <?php $__empty_1 = true; $__currentLoopData = $phoneNumbers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $phoneNumber): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <p><?php echo e($phoneNumber->phone_number); ?></p>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                <p>+60 3-6145 1123</p>
                            <?php endif; ?>
                        </div>
...
<?php echo $__env->make('layouts.main-site', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel-restaurant-main\resources\views/main-site/contact.blade.php ENDPATH**/ ?>